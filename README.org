...
The few functions defined in the top, fmap, reduce, zipWith, flatten, indexs, and more, are used every heavily and essential on understanding 
the major operations in the entire project.
